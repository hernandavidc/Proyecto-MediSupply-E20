...
- **Endpoints**: 
  - `/api/v1/users/*` - Gestión de usuarios y autenticación
...
- **Endpoints**: 
  - `/api/v1/proveedores/*` - **Creación y gestión de proveedores** (CRUD completo, usado por productos)
...
- **Nota**: Los productos referencian proveedores creados en este servicio
