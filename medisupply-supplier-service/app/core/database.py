                ...
                db.add_all(
                    [
                        Certificacion(
                            id=1,
                            codigo="FDA",
                            nombre="FDA (Food and Drug Administration)",
                        ),
                        Certificacion(
                            id=2, codigo="EMA", nombre="EMA (European Medicines Agency)"
                        ),
                        Certificacion(
                            id=3,
                            codigo="INVIMA",
                            nombre="INVIMA (Instituto Nacional de Vigilancia de Medicamentos y Alimentos)",
                        ),
            ...
            if db.query(CategoriaSuministro).count() == 0:
                db.add_all(
                    [
                        ...
                        CategoriaSuministro(
                            id=3, nombre="Insumos quirurgicos y hospitalarios"
                        ),
                        CategoriaSuministro(id=4, nombre="Insumos reactivos"),
                        CategoriaSuministro(id=5, nombre="Pruebas diagnosticas"),
                        CategoriaSuministro(
                            id=6, nombre="Equipos y dispositivos biomédicos"
                        ),
                        CategoriaSuministro(
                            id=7, nombre="Otros (PPE, Materiales varios)"
                        ),
                    ]
                )
            db.commit()
